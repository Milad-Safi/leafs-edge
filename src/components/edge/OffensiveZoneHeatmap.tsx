    ...
    <div style={{ width: "100%", position: "relative" }}>
      ...
      >
        ...
        <svg viewBox="0 0 50 30" width="50" height="30" x="13" y="3" fill={COLORS.PLAIN_WHITE}>
          <path d="M50 29.9225V0.19458C39.0746 0.871745 28.7801 4.22718 19.7861 9.94905C14.1774 13.5278 9.16226 17.9608 4.92212 23.0877C4.32491 23.8177 3.79406 24.4812 3.2632 25.2112C2.40709 26.3187 1.6097 27.4705 0.874357 28.6617C0.60893 29.1262 0.277146 29.5244 0.0117188 29.9889H49.713V29.9225Z" />
        </svg>
        ...
        <g stroke={COLORS.STROKE} strokeWidth="2" strokeMiterlimit="10" fill="none">
          ...
          <path d="M2.06226 77.0239V212.041L201.574 211.71V147.612L201.243 147.214L174.756 111.788C174.663 111.896 174.551 111.986 174.425 112.053L172.637 113.642C169.399 116.471 165.994 119.102 162.44 121.522C161.712 121.985 160.983 122.515
          160.321 122.979L158.136 124.369C157.407 124.833 156.679 125.23 155.951 125.694C155.222 126.091 154.494 126.554 153.766 126.952C152.044 127.879 150.322 128.806 148.534 129.667C148.269 129.799 148.071 129.865 147.806 129.998C147.409 
          130.196 147.011 130.395 146.548 130.594C145.753 130.991 144.959 131.322 144.164 131.653C142.972 132.183 141.846 132.646 140.655 133.11C138.712 133.722 139.674 133.589 139.21 133.722M139.463 134.368V134.434L144.628 150.393L154.825 
          181.647L154.891 181.846L154.957 181.978V182.045" />
          ...
          <path d="M65.6269 134.699C51.8845 129.98 39.2297 122.549 28.4129 112.848L59.2038 71.7267C71.3582 80.9416 86.1977 85.9192 101.45 85.8972C116.977 85.8948 132.066 80.7487 144.359 71.2632L174.753 111.854C164.445 121.315 151.805 128.293 
          138.711 133.223M65.6269 134.699L82.1811 83.381M65.6269 134.699C89.5726 142.906 115.012 142.115 138.711 133.223M138.711 133.223L123.103 83.3147" />
          ...
          <path d="M174.695 111.788L144.302 71.1968L145.096 70.6009C145.692 70.1374 146.288 69.6738 146.884 69.1441C157.504 60.1377 165.203 48.1742 169.001 34.7773C169.067 34.5125 169.133 34.1814 169.199 33.9165H192.177C192.375 34.1814 192.508 
          34.5125 192.706 34.7773C198.528 44.7915 201.59 56.1703 201.579 67.7535V73.5144" />
          ...
          <path d="M2.06228 77.024V67.7535C2.05214 56.1703 5.1139 44.7915 10.9354 34.7773L11.4651 33.9165H33.7803C33.8465 34.1814 33.9127 34.5125 33.9789 34.7773C37.8613 48.4320 45.7779 60.5955 56.6914 69.6738L58.4793 71.0644C58.7441
           71.2631 58.9428 71.3955 59.2077 71.5941L28.4167 112.715" />
        </g>
        ...
        {/* left corner */}
        <rect x="39" y="13" width="12" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="45" y="25" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["L Corner"]}
        </text>

        {/* behind net  */}
        <rect x="96" y="10" width="9" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="101" y="22" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["Behind the Net"]}
        </text>

        <rect x="154" y="13" width="12" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="160" y="25" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["R Corner"]}
        </text>

        <rect x="16" y="63" width="19" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        ...
        <rect x="170" y="63" width="19" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="180" y="75" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["Outside R"]}
        </text>

        <rect x="47" y="93" width="19" height="15" fill={COLORS.RED} rx="2" />
        <text x="57" y="105" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["L Circle"]}
        </text>

        <rect x="93" y="104" width="17" height="15" fill={COLORS.RED} rx="2" />
        <text x="101" y="116" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["High Slot"]}
        </text>

        <rect x="136" y="93" width="19" height="15" fill={COLORS.RED} rx="2" />
        <text x="145" y="105" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["R Circle"]}
        </text>

        <rect x="19" y="146" width="22" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="30" y="155" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["L Point"]}
        </text>

        <rect x="92" y="153" width="18" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
        <text x="101" y="165" textAnchor="middle" style={{ fontWeight: 600, fontSize: 10 }}>
          {vals["Center Point"]}
        </text>

        <rect x="160" y="143" width="20" height="15" fill={COLORS.PLAIN_WHITE} rx="2" />
