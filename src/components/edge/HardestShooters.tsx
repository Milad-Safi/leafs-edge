...
import type { EdgeHardestShooter } from "@/types/api";
...
export default function HardestShooters({
    ...
    if (!rows.length) {
        return <p className="edgeListEmpty">No shot-speed data returned</p>;
    }

    return (
        <ol className="edgeRankList" aria-label="Hardest shooters ranked one to five">
